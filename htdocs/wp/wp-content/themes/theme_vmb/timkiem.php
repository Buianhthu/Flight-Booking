        ...
        <div class="list-search row tab-pane fade in active" id="ve_may_bay" style="margin: 0 auto">
            <div id="row1" style="margin-left: 3rem">
                <div class="dropdown show div-input box-diem go-flight">
                    <!--  -->
                    <input type="text" name="diem-di" data-code="HAN" code="HAN" class="form-control btn-place bt-diem-di btn btn-secondary dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" placeholder="Nhập tên điểm khởi hành" value="Nhập tên địa điểm đi">
                    <!-- <input type="text" name="" class="form-control btn-place bt-diem-di  border-color-red " placeholder="Nhập tên điểm khởi hành"> -->
                    <i class="fa fa-plane" aria-hidden="true"></i>
                    <!-- Box Hidden -->
                    <div class="box-select-option dropdown-menu-1">
                        <!--  -->
                ...
                <div class="dropdown show div-input box-diem back-flight">
                    <input type="text" name="diem-den" class="form-control btn-place bt-diem-den btn btn-secondary dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-code="DIN" code="DIN" placeholder="Nhập tên điểm đến" value="">
                ...
                <div class="div-number dropdown show" style="float:left; width: 20rem">
                    <button class="btn btn-pp dropdown-toggle" aria-haspopup="true" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li class="row m0" data-min="1" data-max="9">
                            <div class="row m0">
                                ...
                                <input type="hidden" name="num-adault-xs" id="num-adault-xs" value="">
                            </div>
                        </li>
                        <li class="row m0">
                            <div class="row m0">
            ...
            <div class="row2">
                <div id="date" style="margin-top:10rem; margin-left:5rem">
                    <?php 
                        $date = date('d-m-Y');
                    ?>
                    <div class="div-date form-date date_di" id="from-container">
                        <div class='input-group date'>
                           
                            <?php
                            echo "<input class='form-control date' id='date_di' name='date_di' placeholder=".$date." width='100px'>";
                            ?>
                    ...
                    <div class="div-date form-date date_ve" id="to-container">
                        <div class='input-group date'>
                            <label style="color:white">Ngày về</label>
                            <?php
                            echo "<input class='form-control date' id='date_ve' name='date_ve' placeholder=".$date." width='100px'>";
                            ?>
                            <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        ...
                        <div class="label-bottom-flight hidden-xs">
                            <input id="journey2"  type="radio" checked="checked" name="journey" value="2"> <label for="journey2">Khứ hồi</label>
                        </div>
                    </div>
                </div>
            </div>
